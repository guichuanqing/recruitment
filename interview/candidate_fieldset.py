...
"""
# @Author : qgc
# @Time : 2022/11/24 17:42
# @File : candidate_fieldset.py
# Description : 文件说明
"""

# 分组展示字段，分三块，基础信息，第一轮面试记录，第二轮面试记录，HR复试
default_fieldsets = (
...
default_fieldsets_first = ((None, {'fields': (
...
default_fieldsets_second = ((None, {'fields': (
"userid", ("username", "city", "phone"), ("email", "apply_position", "born_address"), ("gender", "candidate_remark"),
("bachelor_school", "master_school", "doctor_school"), ("major", "degree"),
("test_score_of_general_ability", "paper_score"), "last_editor",
)}),
